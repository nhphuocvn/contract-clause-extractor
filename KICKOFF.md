...
**⚠ MANUAL VERIFICATION PENDING (first task next session):** open `deal_model_demo.xlsx` in Excel and confirm: (1) no #REF/#NAME errors anywhere, (2) Total Gross Margin = $1,357.5M on the Model tab, (3) changing ASP from 25000 → 26000 on Assumptions tab recalculates Gross Revenue Q1 175M → 182M, (4) flipping RebateToggle to "B-Retroactive" changes the Active Rebate row.
